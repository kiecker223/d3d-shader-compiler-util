...
inline bool operator == (const D3D12_STATIC_SAMPLER_DESC& left, const D3D12_STATIC_SAMPLER_DESC& right)
{
	return (
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC
{
	...
	inline UINT8 PlaneCount(_In_ ID3D12Device1* pDevice) const
	{
		return D3D12GetFormatPlaneCount(pDevice, Format);
	}
	inline UINT Subresources(_In_ ID3D12Device1* pDevice) const
	{
